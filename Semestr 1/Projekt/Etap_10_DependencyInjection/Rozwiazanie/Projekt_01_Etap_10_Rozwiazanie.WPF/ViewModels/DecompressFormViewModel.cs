...
{
    public class DecompressFormViewModel : INotifyPropertyChanged
    {
        ...
        public DecompressFormViewModel(IHuffmanStaticDecompressorService huffmanStaticDecompressorService)
        {
