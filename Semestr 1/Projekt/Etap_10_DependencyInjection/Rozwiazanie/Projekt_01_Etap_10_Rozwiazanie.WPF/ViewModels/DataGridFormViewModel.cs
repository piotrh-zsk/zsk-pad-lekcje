...
{
    public class DataGridFormViewModel : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<SymbolPrintingData> SymbolsPrintingData { get; private set; } = new ObservableCollection<SymbolPrintingData>();
        #endregion Pola tekstowe


        public DataGridFormViewModel(ITextStatisticsService textStatisticsService, CompressForm compressForm, DecompressForm decompressForm)
        {
        ...
        public void PerformTextAnalysis(string fileText)
        {
            ...
            SymbolsPrintingData.Clear();
            foreach (var i in printingData.SymbolStatistics)
                SymbolsPrintingData.Add(i);
            OnPropertyChanged(nameof(SymbolsPrintingData));
        }
