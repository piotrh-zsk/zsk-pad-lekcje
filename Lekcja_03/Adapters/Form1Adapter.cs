...
namespace Lekcja_03.Adapters
{
    public class Form1Adapter
    {
        ...
        private MyBetterOtherServiceWithoutInterface _myOtherServiceWithoutInterface;     // pole deklarujacy konkretną implementację serwisu
        ...
        private void SetSomeDefaultConfigInOthrService(MyBetterOtherServiceWithoutInterface srv, string configValue)
        {
            // jakaś tam przykładowa konfiguracja
            srv.SetSomeConfig(configValue);
        }
